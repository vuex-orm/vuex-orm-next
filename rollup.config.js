...
const configs = [
  { input: 'src/index.ts', file: 'dist/vuex-orm.esm-browser.js', format: 'es', browser: true, env: 'development' },
  { input: 'src/index.ts', file: 'dist/vuex-orm.esm-browser.prod.js', format: 'es', browser: true, env: 'production' },
